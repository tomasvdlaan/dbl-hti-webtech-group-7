...
Blockly.Arduino.serial_read_ = {};
profile["default"] = profile.arduino;
Blockly.Arduino.init = function (a) {
  Blockly.Arduino.definitions_ = Object.create(null);
  Blockly.Arduino.setups_ = Object.create(null);
  Blockly.Arduino.loop_definitions_ = Object.create(null);
  Blockly.Arduino.serial_read_ = Object.create(null);
...
Blockly.Arduino["joystick_setup"] = function () {
  Blockly.Arduino.setups_.setup_input_3 =
    "  for (int i = 0; i < 2; i++) {\n" +
    "     pinMode(3, INPUT);\n" +
    "  }\n" +
    "  Serial.begin(9600);\n";
...
Blockly.Arduino["input"] = function (block) {
  // TODO: Assemble Arduino into code variable.
  var code =
    "  int x = analogRead(A0) - 507;\n" + "  int y = analogRead(A1) - 509;\n";
  return code;
};

Blockly.Arduino["serial_listen"] = function (block) {
  // TODO: Assemble JavaScript into code variable.
  var on_serial = Blockly.Arduino.statementToCode(block, "on_serial");
  Blockly.Arduino.setups_["setup_serial"] = "Serial.begin(9600);";
  Blockly.Arduino.serial_read_["death"] = on_serial;
  //   var code = "Tistiekel " + block.statementToCode(Python.statementToCode(block, "DO"));
  return "";
};

// Blockly.Arduino["p_death"] = function (block) {
//   // TODO: Assemble JavaScript into code variable.
//   var on_death = Blockly.Arduino.statementToCode(block, "on_death");
//   Blockly.Arduino.setups_["setup_serial"] = "Serial.begin(9600);";
...
// Blockly.Arduino["p_score"] = function (block) {
//   // TODO: Assemble JavaScript into code variable.
//   var on_score = Blockly.Arduino.statementToCode(block, "on_score");
//   Blockly.Arduino.setups_["setup_serial"] = "Serial.begin(9600);";
//   Blockly.Arduino.serial_read_["score"] =
//     'if(command == "score")\n{\nSerial.println(\"Jup tottaly dead\");\n' + on_score + "}\n";
//   return "";
// };
